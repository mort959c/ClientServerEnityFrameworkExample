...
namespace MyClient
{
    class ClientFunc
    {
        ...
        public List<Item> GetAllItemsFromServer()
        {
            List<Item> items = new List<Item>();
            string request = createXMLRequestAsString("GetAllItems");
            string response = ClientCom.ConnectToServer(request);
        ...
        public List<Order> getAllOrdersFromServer()
        {
        ...
        public List<IOrderOverview> GetOrdersOverviewFromServer()
        {
            List<Item> items = new List<Item>();
        ...
        //  </OrderList>
        //</CreateOrders>
        public string SendNewOrdersToServer(List<Order> orders)
        {
            ...
            return ClientCom.ConnectToServer(xdoc.ToString(SaveOptions.DisableFormatting));
        }
